        ...
        <section className="py-10 bg-white border-y border-slate-100">
          <div className="max-w-6xl mx-auto px-6">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 lg:gap-0 lg:divide-x lg:divide-slate-200">
              {[
                {icon:<Calendar className="w-5 h-5 text-teal-600"/>, bg:'bg-teal-50', title:'3 Monate kostenlos', sub:'Keine Kreditkarte nötig'},
                ...
                <div className="flex flex-col gap-4 scroll-reveal" style={{transitionDelay:'100ms'}}>
                  <div className="trust-card guarantee-badge rounded-[4px] p-6 border-l-4 border-amber-500 flex-1" style={{borderLeft:'4px solid #f59e0b'}}>
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h3 className="text-lg font-bold text-amber-900 mb-1">3 Monate kostenlos testen</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mb-8">
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm">
                  ...
                  <li><Link href="/kuendigen" className="hover:text-teal-400 transition-colors">Verträge kündigen</Link></li>
                </ul>
              </div>
            </div>
